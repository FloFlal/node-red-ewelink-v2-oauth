module.exports = function(RED) {
    ...
    function EwelinkWebsocket(config) {
        ...
        console.log('[' + new Date() + '] - Initializing eWeLink Websocket Node :' + JSON.stringify(config));
        console.log('[' + new Date() + '] - Initializing eWeLink the client :' + JSON.stringify(node.auth.getWebsocketClient()));
        ...
        var ws = node.auth.getWebsocketClient().Connect.create(
            ...
            (error) => {
                ...
                console.error('[' + new Date() + '] - eWeLink WS connection error: ', error);
                node.status({
                    fill: 'red',
                    shape: 'dot',
                    text: 'on error'
            ...
            (_ws, message) => {
                ...
                console.log('[' + new Date() + '] - eWeLink WS message: ', JSON.stringify(data));
        ...
        console.log('[' + new Date() + '] - eWeLink Websocket Node WS initialized');
        ...
        console.log('[' + new Date() + '] - eWeLink Websocket Node end of node configuration');
    }
